...
function Authentification(props) {
    ...
    let form = (
        <form onSubmit={(e) => formHandler(e)}>
           ...
           {/* <button onClick={registerClickedHandler} disabled={!valid} className={classes.button}>Inscription</button>  Inscription au site */}
            </div>
        </form>
    );
    ...
    return (
        <>
            ...
            <div className={classes.form}>
                {loginError ? <div className={classes.alert}>Mot de passse ou adresse email incorrect.</div> : null}
